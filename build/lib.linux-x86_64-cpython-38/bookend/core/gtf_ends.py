            ...
            if transcript.strand == 1:
                ...
                if self.extend is None:
                    ...
                    start = (
                        ...
                        min(sbound, int(transcript.attributes.get('S.right',pos+1))),
                        pos, 
                        startname
                    ) 
                    pos = transcript.right()
                    end = (
                        max(ebound, int(transcript.attributes.get('E.left',pos-1))),
                    ...
                    start = (
                        ...
                        min(sbound, int(transcript.attributes.get('S.right',pos+1))+self.extend),
                        pos,
                        startname
                    )
                    pos = transcript.right()
                    end = (
                        max(ebound, int(transcript.attributes.get('E.left',pos-1))-self.extend),
                ...
                if self.extend is None:
                    pos = transcript.right()
                    start = (
                        max(sbound, int(transcript.attributes.get('S.left',pos-1))), 
                    ...
                    pos = transcript.left()
                        ...
                        min(ebound, int(transcript.attributes.get('E.right',pos+1))), 
                        pos, 
                        endname
                    )
                else:
                    pos = transcript.right()
                    start = (
                        max(sbound, int(transcript.attributes.get('S.left',pos-1))-self.extend),
                    ...
                    pos = transcript.left()
                        ...
                        min(ebound, int(transcript.attributes.get('E.right',pos+1))+self.extend), 
                        pos, 
                        endname
                    )
